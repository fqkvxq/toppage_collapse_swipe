...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                  <h2 class="text-center">
                    <button class="btn collapse_button btn-link" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseOne">
                    <span class="h4">期間工募集中メーカー一覧</span>
                    <br>
                    <span class="h6">(タップして開閉します)</span>
                    </button>
                  </h2><!--/collapseTrigger-->
        ...
        <div class="row">
            <div class="col-12">
                  <h2 class="text-center">
                    <button class="btn collapse_button btn-link" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseOne">
                    <span class="h4">期間工のミカタとは？</span>
                    <br>
                    <span class="h6">(タップして開閉します)</span>
                    </button>
                  </h2><!--/collapseTrigger-->
